...
({
    ...
    getFormData: function (component, event, helper) {
        ...
        var cartId = component.get('v.currCartId');
        action.setParams({currCartId: cartId});
    ...
    parseReceivedFormData: function (component, event, helper) {
        ...
        if (cybersourceHostedFormData != null) {
            ...
            component.set('v.merchant_defined_data1', cybersourceHostedFormData.cartSFId);
            ...
            component.set('v.paymentTypes', cybersourceHostedFormData.paymentTypesList);
    ...
    processCyberSourceCallback: function (component, cyberSourceResponse) {
        var action = component.get('c.processCyberSourceResponse');
        var cart = component.get('v.cart');
        action.setParams({cart: cart, cybersourcePaymentResponse : cyberSourceResponse});
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === 'SUCCESS' && returnValue != null) {
                if (returnValue.success == 'true'){
                    ...
                    component.set('v.showOrderInfo',true);
                    this.showToastMessage('Success',returnValue.message,'Success');
                } else {
                    this.showToastMessage('Error.',returnValue.message,'Error');
                }
            }
            else {
                this.showToastMessage('Error', 'There was a problem processing your request.', 'Error');
            }
            component.set('v.showSpinner', false);
        });
        component.set('v.showSpinner', true);
